...
namespace
{
    ...
    struct Preset { const char* label; float amp, mode, tube, topo, drive, sag, pres, depth; };

    const std::vector<Preset> kMatrix = {
        //  label                          amp  mode  tube    topo drive  sag   pres  depth
        { "00-ref-cab-only-no-poweramp",   0.f, 1.f,  0.f,    0.f, 0.50f, 0.f,  0.f,  0.f  }, // A/B baseline: DI→cab, tube off
        { "01-6L6-crunch",                 1.f, 1.f,  0.000f, 0.f, 0.55f, 0.4f, 0.4f, 0.4f },
        { "02-EL34-crunch",                1.f, 1.f,  0.333f, 0.f, 0.55f, 0.4f, 0.4f, 0.4f },
        { "03-EL84-crunch",                1.f, 1.f,  0.667f, 0.f, 0.55f, 0.4f, 0.4f, 0.4f },
        { "04-KT88-crunch",                1.f, 1.f,  1.000f, 0.f, 0.55f, 0.4f, 0.4f, 0.4f },
        { "05-EL34-clean",                 1.f, 1.f,  0.333f, 0.f, 0.25f, 0.2f, 0.3f, 0.3f },
        { "06-EL34-hot",                   1.f, 1.f,  0.333f, 0.f, 0.85f, 0.7f, 0.6f, 0.6f },
        { "07-EL34-hot-DRY-no-feel",       1.f, 1.f,  0.333f, 0.f, 0.85f, 0.0f, 0.0f, 0.0f }, // isolate the block-2 core
        { "08-EL34-hot-SAG-only",          1.f, 1.f,  0.333f, 0.f, 0.85f, 0.9f, 0.0f, 0.0f }, // isolate sag
        { "09-EL34-hot-SE-classA",         1.f, 1.f,  0.333f, 1.f, 0.85f, 0.7f, 0.6f, 0.6f }, // even-harmonic single-ended
        { "10-EL84-hot-SE",                1.f, 1.f,  0.667f, 1.f, 0.80f, 0.8f, 0.7f, 0.7f },
        { "11-KT88-hifi-clean",            1.f, 1.f,  1.000f, 0.f, 0.30f, 0.2f, 0.2f, 0.4f },
    };
}
...
int main (int argc, char** argv)
{
    ...
    for (const auto& ps : kMatrix)
    {
        ...
        setP ("tubeSag", ps.sag); setP ("tubePresence", ps.pres); setP ("tubeDepth", ps.depth);
        pump (60);
